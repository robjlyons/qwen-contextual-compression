...
def main(argv=None):
 ...
 tokenizer=AutoTokenizer.from_pretrained(a.model,revision=a.revision,cache_dir=a.cache_dir);dtype=torch.float16 if a.activation_dtype=="fp16" else torch.bfloat16
